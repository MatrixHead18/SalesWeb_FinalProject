...
using PROJETOFINAL_SalesWeb.Models.Enums;

namespace PROJETOFINAL_SalesWeb.Data
{
    public class SeedingService
    {
        private PROJETOFINAL_SalesWebContext _context;

        public SeedingService(PROJETOFINAL_SalesWebContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1978, 3, 23), 3000.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1938, 2, 25), 5000.0, d1);
            Seller s4 = new Seller(4, "Martha Reid", "martha@gmail.com", new DateTime(1958, 5, 27), 4200.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(1928, 7, 25), 5600.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", new DateTime(1978, 8, 29), 17000.0, d2);
